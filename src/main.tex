...
\begin{itemize}
  ...
  \item Enables pariticipants to record and practice vowel production
\end{itemize}
\end{block}
...
\includegraphics[width=0.95\linewidth]{plots/axb-boxplot.png}
\end{tikzfigure}
\end{figure}
...
\includegraphics[width=0.95\linewidth]{plots/vowel-plot.png}
\end{tikzfigure}
\end{figure}
...
\begin{tikzfigure}[ks-plot]
\includegraphics[width=0.45\linewidth]{plots/ks-plot.png}
\end{tikzfigure}
\hfill
\begin{tikzfigure}[duration-plot]
\includegraphics[width=0.225\linewidth]{plots/duration-plot.png}
\includegraphics[width=0.225\linewidth]{plots/duration-model.png}
\end{tikzfigure}
...
\begin{itemize}
  ...
  for LV or HV participants between pre- and post- test \tikzfigureref{axb-plot}
  \item
  In line with previous results \cite{hattori_2009} where
  production training did not benefit perception
...
between pre- and post- test \tikzfigureref{vowel-plot}
\item
Kolmogorov-Smirnov (K-S) distance between children and SSBE
speaker's f1
decreases between pre- and post- test \tikzfigureref{ks-plot} although
this is not significant

\item
 Monophthong duration \tikzfigureref{duration-plot}
 increases significantly between pre- and post- test
 for both LV and HV groups (F=68.532, p <0.0001)
