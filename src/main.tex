...
\begin{itemize}
  ...
  \item
  This result is in line with previous results \cite{alshangiti_2015, hattori_2009}, where
...
\begin{itemize}
\item Both LV and HV children show changes in some vowel production
between pre- and post- test.
Vowels centres --- SSBE vowels from \citep{hawkins_midgely_2005} ---
shown in \tikzfigureref{vowel-plot}
\item
Mahalanobis-distance classification according to SSBE model
(using data from \citep{hawkins_midgely_2005})
shows improvement for LV speakers between pre- and post- test
\tikzfigureref{mahalanobis-plot}
although this just fails to reach significance (p=0.0528)

\item
 Monophthong duration \tikzfigureref{duration-plot}
 increases significantly between pre- and post- test
 for both LV and HV groups (F(1,726)=68.532, p <0.0001)
