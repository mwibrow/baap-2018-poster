...
\begin{itemize}
  ...
  \item
  Replicates previous results \cite{alshangiti_2015, hattori_2009}, where
...
shows improvement for LV speakers between pre-tests and post-tests
...
\begin{itemize}
  ...
  but may be due to task demands (learning 18 vowels in 5 sessions),
